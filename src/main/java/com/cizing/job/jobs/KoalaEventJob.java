...
import com.cizing.service.jobs.koala.KoalaJobService;
...
public class KoalaEventJob extends InitializationJob {

    private final static Logger log = LoggerFactory.getLogger(KoalaEventJob.class);

    private final String JOB_NAME = "koalaJob";
    private final String JOB_GROUP = "koalaGroup";
    private final String TRIGGER_NAME = "koalaTrigger";
    private final String TRIGGER_GROUP = "koalaTriggerGroup";
    private final String CRON = "0/20 * * * * ? ";

    @Autowired
    KoalaJobService koalaJobService;

    @Override
    public void execute(JobExecutionContext jobExecutionContext) {
        log.info("koala job start at " + new Date());
        koalaJobService.insertUpkeepTasksByRuntime();
    }
